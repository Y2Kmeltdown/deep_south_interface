// system_manager_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_7ija6ea.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module system_manager_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_7ija6ea #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 74,
	...
	system_manager_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 74,          .data
		...
		.out_data          (out_data),          //  output,  width = 74,          .data
