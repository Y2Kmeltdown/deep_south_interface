...
source "$script_dir/hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_utils.tcl"

load_package sdc_ext

proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_ddr_pins { instname allpins var_array_name} {
   ...
   set pll_ref_clock_id [hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_input_clk_id $pins(pll_cascade_in_id) var]
   if {$pll_ref_clock_id == -1} {
      post_message -type critical_warning "hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_pin_map.tcl: Failed to find PLL reference clock"
   } else {
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_initialize_hbm_db { hbm_db_par var_array_name} {
   upvar $hbm_db_par local_hbm_db
   upvar 1 $var_array_name var

   global ::GLOBAL_hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_corename

   post_sdc_message info "Initializing HBM database for CORE $::GLOBAL_hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_corename"
   set instance_list [hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_core_instance_list $::GLOBAL_hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_corename]

   foreach instname $instance_list {

      post_sdc_message info "Finding port-to-pin mapping for CORE: $::GLOBAL_hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_corename INSTANCE: $instname"
      hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_ddr_pins $instname allpins var
      hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_verify_ddr_pins allpins var

      set local_hbm_db($instname) [ array get allpins ]
   }
}

proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_verify_ddr_pins { pins_par var_array_name} {
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_input_clk_id { pll_inclk_id var_array_name} {
   upvar 1 $var_array_name var

   array set results_array [list]

   hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_traverse_fanin_up_to_depth $pll_inclk_id hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_is_node_type_pin clock results_array $var(pll_inclock_search_depth)
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_is_node_type_pll_clk { node_id } {
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_is_node_type_vco { node_id } {
   set cell_id [get_node_info -cell $node_id]
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_does_ref_clk_exist { ref_clk_name } {
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_periphery_clock_uncertainty { results_array_name var_array_name } {
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_core_clock_uncertainty { results_array_name var_array_name } {
   upvar 1 $results_array_name results
   upvar 1 $var_array_name var
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_core_overconstraints { results_array_name var_array_name } {
   upvar 1 $results_array_name results
   upvar 1 $var_array_name var
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_periphery_overconstraints { results_array_name var_array_name } {
   upvar 1 $results_array_name results
   upvar 1 $var_array_name var
...
proc hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_sort_duplicate_names { names_array } {
