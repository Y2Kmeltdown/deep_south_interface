...
source "$script_dir/hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_ip_parameters.tcl"
source "$script_dir/hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_parameters.tcl"
source "$script_dir/hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_pin_map.tcl"
...
set entity_names_on [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_are_entity_names_on ]
...
set ref_period      [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_round_3dp [ expr $var(PHY_REF_CLK_FREQ_PS)/1000.0] ]
set ref_half_period [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_round_3dp [ expr $ref_period / 2.0 ] ]
set cal_period      [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_round_3dp [ expr $var(PHY_CAL_CLK_FREQ_PS)/1000.0] ]
set cal_half_period [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_round_3dp [ expr $cal_period / 2.0 ] ]
...
#if { ! [ info exists hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_sdc_cache ] } {
   hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_initialize_hbm_db hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_hbm_db var
   set hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_sdc_cache 1
#} else {
#   if { $debug } {
...
set instances [ array names hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_hbm_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_hbm_db($inst)
   ...
   set ref_clock_exists [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_does_ref_clk_exist $pins(pll_ref_clock) ]
   ...
   set pins(ref_clock_name) [hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_clock_name_from_pin_name $pins(pll_ref_clock)]
   
   if {[get_collection_size $pins(ncntr_id)] == 1} {
      set local_ncntr_clk [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
         -target $pins(ncntr) \
         -name "${inst}_ncntr" \
      ...
      if {$var(PLL_NCNTR_SETTING) == 1} {
         post_message -type warning "hbm_top_example_design_altera_abstract_uib_191_4v7vvyy.sdc: Inconsistent N-counter setting, expecting larger than 1 setting"
      }
   } else {
      set vco_base_clk $pins(pll_ref_clock)
      if {$var(PLL_NCNTR_SETTING) != 1} {
         post_message -type warning "hbm_top_example_design_altera_abstract_uib_191_4v7vvyy.sdc: Inconsistent N-counter setting, expecting setting to be 1"
      }
   }
   ...
   # VCO clock
   set local_pll_vco_clk [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   if {$pins(cpa_core_clk1_clock) != ""} {
      ...
      set local_core_clk1_clock [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   if {$pins(cpa_core_clk0_clock) != ""} {
      ...
      set local_core_clk0_clock [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   if {$pins(core_fr_usr_clock) != ""} {
      set local_core_fr_usr_clock [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   if {$pins(core_hr_usr_clock) != ""} {
      set local_core_hr_usr_clock [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   set phase [expr {$var(PLL_PHY_CLK_VCO_PHASE) * 45.0 / $divide_by}]
   set local_phy_clk [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
   ...
   set phase [expr {$var(PLL_PHY_CLK_VCO_PHASE) * 45.0 / $divide_by}]
   set local_phy_clk_l [ hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_or_add_generated_clock \
  ...
  foreach_in_collection reg $regs {
   ...
   if {($fit_flow == 1 || $sta_flow == 1)} {
      ...
      hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_periphery_clock_uncertainty periphery_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_periphery_overconstraints periphery_overconstraints  var
      } else {
      ...
      hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_core_clock_uncertainty core_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_get_core_overconstraints core_overconstraints var
      } else {
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_hbm_top_example_design_altera_abstract_uib_191_4v7vvyy_corename}_report_timing.tcl]]"
