	...
	end component tg_bottom0_0;

	u0 : component tg_bottom0_0
		port map (
			...
			ur_paddr            => CONNECTED_TO_ur_paddr,            --         apb.ur_paddr
			ur_psel             => CONNECTED_TO_ur_psel,             --            .ur_psel
			ur_penable          => CONNECTED_TO_ur_penable,          --            .ur_penable
			ur_pwrite           => CONNECTED_TO_ur_pwrite,           --            .ur_pwrite
			ur_pwdata           => CONNECTED_TO_ur_pwdata,           --            .ur_pwdata
			ur_pstrb            => CONNECTED_TO_ur_pstrb,            --            .ur_pstrb
			ur_prready          => CONNECTED_TO_ur_prready,          --            .ur_prready
			ur_prdata           => CONNECTED_TO_ur_prdata            --            .ur_prdata
		);
