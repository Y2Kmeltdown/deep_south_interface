...
module altera_hbm_tg_axi_rw_stage # (
   ...
   localparam ADDR_COUNT            = DIAG_MIXED_TRAFFIC ? ((TG_TEST_DURATION == "SHORT" || TG_USE_EFFICIENCY_PATTERN) ? 8 : 64) : (BURST_LEN_EXTEND_EN ?  ((TG_TEST_DURATION == "SHORT") ? 8 : 512): 64);
   ...
   assign block_size = (block_rw_mode | repeat_mode) ? (DIAG_MIXED_TRAFFIC ? ((TG_TEST_DURATION == "SHORT" || TG_USE_EFFICIENCY_PATTERN) ? 16 : 64) : ((TG_TEST_DURATION == "SHORT" && BURST_LEN_EXTEND_EN) ? ((BURST_COUNT_MODE == "SEQ") ? 32 : 8) : 25)) : 1;
