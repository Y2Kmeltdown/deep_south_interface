...
//////////////////////////////////////////////////////////////////////////////
module altera_hbm_tg_axi_one_hot_addr_gen # (
   ...
   begin
      ...
      if (rst || start)
         one_hot_addr <= (ADDR_WIDTH > 32) ? {(ADDR_WIDTH){1'b0}} | WORD_ADDRESS_DIVISIBLE_BY[MAX_PARAM_WIDTH-1:0] : WORD_ADDRESS_DIVISIBLE_BY[ADDR_WIDTH-1:0];
      else if (enable) begin
         if (one_hot_addr[AMM_WORD_ADDRESS_WIDTH-1]) begin
            one_hot_addr <= (ADDR_WIDTH > 32) ? {(ADDR_WIDTH){1'b0}} | WORD_ADDRESS_DIVISIBLE_BY[MAX_PARAM_WIDTH-1:0] : WORD_ADDRESS_DIVISIBLE_BY[ADDR_WIDTH-1:0];
         end else begin
