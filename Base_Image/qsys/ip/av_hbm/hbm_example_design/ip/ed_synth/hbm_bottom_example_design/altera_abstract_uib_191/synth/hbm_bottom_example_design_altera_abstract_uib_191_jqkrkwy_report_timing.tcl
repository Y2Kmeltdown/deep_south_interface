...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_initialize_hbm_db hbm_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_corename}"
   } else {
      set fbasename "${::GLOBAL_hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_corename}_${inst_id}"
   }
   ...
   hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance   

   set summary [lsort -command hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_sort_proc $summary]

   set f -1
   set fname "${fbasename}_summary.csv"

   if { [hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_get_operating_conditions_number] == 0 } {
      set f [open $fname w]

      puts $f "Core: ${::GLOBAL_hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_corename} - Instance: $inst"
   ...
   post_message -type info "Core: ${::GLOBAL_hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_round_3dp $hold]
      }
