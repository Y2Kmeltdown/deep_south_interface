...
module hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_top #(
   ...
   parameter SEQ_SYNTH_CODE_HEX_FILENAME             = "hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_top_uibssm_synth.hex",
   parameter SEQ_SYNTH_CODE_FW_FILENAME              = "",
   parameter SEQ_SYNTH_PARAMS_HEX_FILENAME           = "hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_top_seq_params_synth.hex",
   parameter SEQ_SYNTH_CAL_CLK_DIVIDE                = 0,

   parameter SEQ_SIM_CODE_HEX_FILENAME               = "hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_top_uibssm_sim.hex",
   parameter SEQ_SIM_CODE_FW_FILENAME                = "",
   parameter SEQ_SIM_PARAMS_HEX_FILENAME             = "hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_top_seq_params_sim.hex",
...
`endif
   ...
   logic real_axifencereq_1, real_axifencereq_2/*synthesis dont_merge */;
   wire pll_locked;
   logic hipi_cal_in_prog;
   logic fake_cal_success, fake_cal_fail;
   logic sync_cal_sts, sync_cal_in_prog_1, sync_cal_in_prog_2, sync_cal_in_prog_3, sync_cal_in_prog_4/*synthesis dont_merge */;
   ...
   begin
      if (!wmcrst_to_use) begin
         ...
         fake_cal_success    <=  0;
         sync_cal_sts <= 1'b0;
         sync_cal_in_prog_1 <= 1'b1;
         sync_cal_in_prog_2 <= 1'b1;
         sync_cal_in_prog_3 <= 1'b1;
         sync_cal_in_prog_4 <= 1'b1;
         real_axifencereq_1 <= 1'b1;
         real_axifencereq_2 <= 1'b1;
   ...
   assign cal_in_prog = LOCAL_DIAG_ABSTRACT_PHY ? !local_cal_success && !local_cal_fail : sync_cal_in_prog_4;
   assign axifencereq = LOCAL_DIAG_ABSTRACT_PHY ? 1'b0 : real_axifencereq_2;
   assign cal_lat = LOCAL_DIAG_ABSTRACT_PHY ? 0 : real_cal_lat;
   assign local_cal_success = LOCAL_DIAG_ABSTRACT_PHY ? fake_cal_success : (!cal_in_prog && cal_sts);
   assign local_cal_fail = LOCAL_DIAG_ABSTRACT_PHY ? fake_cal_fail : (!cal_in_prog && !cal_sts);
   assign wmcrst_n = PHY_CONFIG_ENUM == "CONFIG_PHY_ONLY" ? cal_sts : (wmcrst_to_use & apply_tg_rst_n);
   ...
   wire  [31 :  0] c2f_pio_out_port_phy_mod = LOCAL_DIAG_ABSTRACT_PHY ? {cal_lat, cal_in_prog, cal_sts} : c2f_pio_out_port_phy;
   ...
   generate
      ...
      // synthesis translate_on
         altera_hbm_arch_nd_pll_hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy pll_inst (
            .*
         );
      // synthesis translate_off
      end
   ...
   .HBMC_CH7_CORE_CLOCK_PS(HBMC_CH7_CORE_CLOCK_PS)
      ...
      if (LOCAL_DIAG_ABSTRACT_PHY) begin
         ...
         if (!PLL_CPA_ONLY_MODE) begin
            ...
            hbm_bottom_example_design_altera_abstract_uib_191_jqkrkwy_uibssm #(
