...
module altera_hbm_tg_axi_config_error_module # (
   ...
   begin
      if (reset) begin
         ...
         config_error_report[ERR_BURSTLENGTH_GT_SEQ_ADDR_INCR]       <= sequential_addr_mode & (burstlength > (seq_addr_incr * 2'b10));
         config_error_report[ERR_ADDR_DIVISIBLE_BY_GT_SEQ_ADDR_INCR] <= sequential_addr_mode & (seq_addr_incr < WORD_ADDRESS_DIVISIBLE_BY[SEQ_ADDR_INCR_WIDTH-1:0]);
         config_error_report[ERR_SEQ_ADDR_INCR_NOT_DIVISIBLE]        <= sequential_addr_mode & (config_error_report[ERR_ADDR_DIVISIBLE_BY_GT_SEQ_ADDR_INCR] | (seq_addr_incr != (seq_addr_incr & ~(WORD_ADDRESS_DIVISIBLE_BY[SEQ_ADDR_INCR_WIDTH-1:0] - 1'b1))));
