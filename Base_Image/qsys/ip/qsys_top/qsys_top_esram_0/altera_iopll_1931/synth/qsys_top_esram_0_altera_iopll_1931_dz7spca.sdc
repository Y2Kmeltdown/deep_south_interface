...
#    * The helper routines are defined in qsys_top_esram_0_altera_iopll_1931_dz7spca_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/qsys_top_esram_0_altera_iopll_1931_dz7spca_parameters.tcl"
source "$script_dir/qsys_top_esram_0_altera_iopll_1931_dz7spca_pin_map.tcl"
...
if {[info exists ::GLOBAL_top_qsys_top_esram_0_altera_iopll_1931_dz7spca_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_qsys_top_esram_0_altera_iopll_1931_dz7spca_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_qsys_top_esram_0_altera_iopll_1931_dz7spca_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_qsys_top_esram_0_altera_iopll_1931_dz7spca_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_qsys_top_esram_0_altera_iopll_1931_dz7spca_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
