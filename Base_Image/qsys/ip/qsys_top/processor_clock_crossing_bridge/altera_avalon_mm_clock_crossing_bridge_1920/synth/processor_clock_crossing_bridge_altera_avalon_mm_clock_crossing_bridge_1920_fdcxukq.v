...
`timescale 1 ns / 1 ns
module processor_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_1920_fdcxukq 
#(
...
(
    ...
    processor_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_2w3unsi #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    processor_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_qtw4p6a #(
        .SYMBOLS_PER_BEAT   (1),
