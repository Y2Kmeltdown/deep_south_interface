	component pipe_mm_bridge_0 is
		...
		port (
			...
			s0_byteenable    : in  std_logic_vector(71 downto 0)                 := (others => 'X'); -- byteenable
			...
			m0_byteenable    : out std_logic_vector(71 downto 0);                                    -- byteenable
			m0_debugaccess   : out std_logic                                                         -- debugaccess
		);
	end component pipe_mm_bridge_0;

	u0 : component pipe_mm_bridge_0
		generic map (
