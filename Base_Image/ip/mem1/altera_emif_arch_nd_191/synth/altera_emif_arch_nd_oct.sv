...
module altera_emif_arch_nd_oct #(
   ...
   parameter PLL_REF_CLK_FREQ_PS = 1,
   ...
   if (PHY_CALIBRATED_OCT) begin : cal_oct
      ...
      if (PHY_USERMODE_OCT) begin : manual_oct_cal
         ...
         ST_OCTFSM      r_octfsm_cs /* synthesis ignore_power_up */;
         ...
         always_ff @(posedge w_oct_clock)
         begin
            r_cal_rst_metasync[2:0] <= {r_cal_rst_metasync[1:0], ~pll_locked};
         end
