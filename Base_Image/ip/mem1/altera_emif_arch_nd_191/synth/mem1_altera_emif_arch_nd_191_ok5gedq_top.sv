...
//
///////////////////////////////////////////////////////////////////////////////
module mem1_altera_emif_arch_nd_191_ok5gedq_top #(
...
`endif
   ...
   // I/O Aux
   ////////////////////////////////////////////////////////////////////////////
   mem1_altera_emif_arch_nd_191_ok5gedq_io_ssm # (
   ...
   ////////////////////////////////////////////////////////////////////////////
   generate
      genvar tile_i, lane_i, pin_i, sig_i;

      if (!WIRELUTS_FOR_C2P || IS_HPS) begin : no_c2p_wluts
            ...
            begin: lane_gen
               ...
               begin: data_gen
                  fourteennm_lcell_comb # (
                     ...
                     .dataa   (core2l_data[tile_i][lane_i][pin_i]),
                     .combout (wlut_core2l_data[tile_i][lane_i][pin_i])
                  );
               end
               ...
               begin: oe_gen
                  fourteennm_lcell_comb # (
                     ...
                     .dataa   (core2l_oe[tile_i][lane_i][pin_i]),
                     .combout (wlut_core2l_oe[tile_i][lane_i][pin_i])
                  );
               end
               ...
               begin: rdata_en_full_gen
                  fourteennm_lcell_comb # (
                     ...
                     .dataa   (core2l_rdata_en_full[tile_i][lane_i][sig_i]),
                     .combout (wlut_core2l_rdata_en_full[tile_i][lane_i][sig_i])
                  );
               end
               ...
               begin: mrnk_gen
                  fourteennm_lcell_comb # (
                     ...
                     .dataa   (core2l_mrnk_read[tile_i][lane_i][sig_i]),
                     .combout (wlut_core2l_mrnk_read[tile_i][lane_i][sig_i])
                  );

                  fourteennm_lcell_comb # (
                     .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                     .dont_touch ("on")
                  ) wlut_mrnk_write_inst (
                     .dataa   (core2l_mrnk_write[tile_i][lane_i][sig_i]),
                     .combout (wlut_core2l_mrnk_write[tile_i][lane_i][sig_i])
                  );
               end
            end
         end
         ...
         if (HMC_AVL_PROTOCOL_ENUM == "CTRL_AVL_PROTOCOL_ST") begin : ast
            ...
            begin: ecc_gen
               fourteennm_lcell_comb # (
                  ...
                  .dataa   (core2l_wr_ecc_info_0[sig_i]),
                  .combout (wlut_core2l_wr_ecc_info_0[sig_i])
               );
               ...
               fourteennm_lcell_comb # (
                  ...
                  .dataa   (core2l_wr_ecc_info_1[sig_i]),
                  .combout (wlut_core2l_wr_ecc_info_1[sig_i])
               );
            end
            ...
            fourteennm_lcell_comb # (
               ...
               .dataa   (core2l_wr_data_vld_ast_0),
               .combout (wlut_core2l_wr_data_vld_ast_0)
            );
            ...
            fourteennm_lcell_comb # (
               ...
               .dataa   (core2l_wr_data_vld_ast_1),
               .combout (wlut_core2l_wr_data_vld_ast_1)
            );
            ...
            fourteennm_lcell_comb # (
               ...
               .dataa   (core2l_rd_data_rdy_ast_0),
               .combout (wlut_core2l_rd_data_rdy_ast_0)
            );
            ...
            fourteennm_lcell_comb # (
               ...
               .dataa   (core2l_rd_data_rdy_ast_1),
               .combout (wlut_core2l_rd_data_rdy_ast_1)
            );
