...
//
///////////////////////////////////////////////////////////////////////////////
module altera_emif_arch_nd_abphy_mux #(
   ...
   output logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_a,          //lane-to-buffer emif_phy_out_a signal
   ...
   output logic                                                                                  core2seq_reset_req_iotile_in,           // For abstract phy support
   output logic                                                                                  pll_locked_iotile_in,                   // Indicates PLL lock status
   output logic                                                                                  pll_dll_clk_iotile_in,                  // PLL -> DLL output clock
   output logic [7:0]                                                                            phy_clk_phs_iotile_in,                  // FR PHY clock signals (8 phases, 45-deg apart)
   output logic [1:0]                                                                            phy_clk_iotile_in,                      // {phy_clk[1], phy_clk[0]}
   output logic                                                                                  phy_fb_clk_to_tile_iotile_in,           // PHY feedback clock (to tile)
   output logic [1:0]                                                                            core_clks_fb_to_cpa_pri_iotile_in,           // Core clock feedback signals to the CPA of primary interface
   output logic [1:0]                                                                            core_clks_fb_to_cpa_sec_iotile_in,           // Core clock feedback signals to the CPA of secondary interface (ping-pong only)
   output logic [62:0]                                                                           core2ctl_avl_0_iotile_in,
   output logic [62:0]                                                                           core2ctl_avl_1_iotile_in,
   ...
   output logic [17:0]                                                                           c2t_afi_iotile_in,
   ...
   output logic [PINS_IN_RTL_TILES-1:0]                                                          b2l_data_iotile_in,                  // buffer-to-lane data
   output logic [LANES_IN_RTL_TILES-1:0]                                                         b2t_dqs_iotile_in,                   // buffer-to-tile DQS
   output logic [LANES_IN_RTL_TILES-1:0]                                                         b2t_dqsb_iotile_in,                  // buffer-to-tile DQSb
   ...
   output logic [PORT_DFT_ND_PA_DPRIO_REG_ADDR_WIDTH-1:0]                                        pa_dprio_reg_addr_iotile_in,
   output logic                                                                                  pa_dprio_rst_n_iotile_in,
   output logic                                                                                  pa_dprio_write_iotile_in,
   output logic [PORT_DFT_ND_PA_DPRIO_WRITEDATA_WIDTH-1:0]                                       pa_dprio_writedata_iotile_in,
   
   input  logic                                                                                  phy_fb_clk_to_pll_abphy,   // PHY feedback clock (to PLL)
   ...
   input  logic [26:0]                                                                           t2c_afi_abphy,
   ...
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_data_abphy,         // lane-to-buffer data
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_oe_abphy,           // lane-to-buffer output-enable
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_dtc_abphy,          // lane-to-buffer dynamic-termination-control
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_a_abphy,          //lane-to-buffer emif_phy_out_a signal
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_b_abphy,          
   input  logic                                                                                  pa_dprio_block_select_abphy,
   input  logic [PORT_DFT_ND_PA_DPRIO_READDATA_WIDTH-1:0]                                        pa_dprio_readdata_abphy,
   ...
   input  logic [26:0]                                                                           t2c_afi_nonabphy,
   ...
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_a_nonabphy,          //lane-to-buffer emif_phy_out_a signal
   input  logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_b_nonabphy,          
   input  logic                                                                                  pa_dprio_block_select_nonabphy,
   input  logic [PORT_DFT_ND_PA_DPRIO_READDATA_WIDTH-1:0]                                        pa_dprio_readdata_nonabphy,
   ...
   generate
     ...
     begin : nonabphy_connections
           ...
           assign l2b_e_a                                            = l2b_e_a_nonabphy;
           assign l2b_e_b                                            = l2b_e_b_nonabphy;
