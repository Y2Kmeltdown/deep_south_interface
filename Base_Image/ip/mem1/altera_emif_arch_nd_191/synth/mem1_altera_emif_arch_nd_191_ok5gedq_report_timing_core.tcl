...
#############################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_read_capture_analysis {opcname inst pin_array_name var_array_name summary_name} {
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_UI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_UI)]]

   set var(RD_ISI) $var(RD_ISI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_ISI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_ISI)]]

   set var(RD_SSI) $var(RD_SSI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_SSI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_SSI)]]

   set var(RD_DQSQ) [expr $var(tDQSQ)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_DQSQ]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_DQSQ)]]

   set var(RD_QH) [expr (1-$var(tQH)*2)*$var(tCK)/2]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_QH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_QH)]]

   set var(RD_MPR) [expr ($var(WITH_MPR) == 1 ? -$var(RD_DQSQ)*$var(MPR_DQSQ)-$var(RD_QH)*$var(MPR_QH) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_MPR]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_MPR)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_JITTER]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_JITTER)]]

   set var(RD_DCD) $var(RD_DCD)
   if {$var(PROTOCOL) == "DDR4"} {
      set var(RD_DCD) [expr {$var(RD_DCD)*0.750/($var(EXTRACTED_PERIOD))}]
   }
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_DCD]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_DCD)]]

   set var(RD_SH) $var(RD_SH)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_SH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_SH)]]

   set var(RD_EOL) $var(RD_EOL)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_EOL]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_EOL)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_CAL_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_CAL_UNC)]]

   set var(RD_SK_EFFECT) [expr ($var(BD_PKG_SKEW)-$var(DEFAULT_BD_PKG_SKEW))*$var(BD_SK_SENS_RD)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_SK_EFFECT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_SK_EFFECT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter RD_MARGIN]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(RD_MARGIN)]]
   ...
   lappend global_summary [list $opcname 0 "$analysis_name ($opcname)" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $setup_slack] [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $hold_slack]]
}
...
#############################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_write_launch_analysis {opcname inst pin_array_name var_array_name summary_name} {
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_UI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_UI)]]

   set var(WR_ISI) $var(WR_ISI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_ISI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_ISI)]]

   set var(WR_SSO) $var(WR_SSO)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_SSO]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_SSO)]]

   set var(WR_DS) [expr $var(tDS)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_DS]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_DS)]]

   set var(WR_DH) [expr $var(tDH)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_DH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_DH)]]

   set var(WR_MPR) [expr ($var(WITH_MPR) == 1 ? -$var(WR_DS)*$var(MPR_DS) -$var(WR_DH)*$var(MPR_DH) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_MPR]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_MPR)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_JITTER]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_JITTER)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_DCD]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_DCD)]]

   set var(WR_EOL) $var(WR_EOL)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_EOL]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_EOL)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_CAL_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_CAL_UNC)]]

   set var(WR_SK_EFFECT) [expr ($var(BD_PKG_SKEW)-$var(DEFAULT_BD_PKG_SKEW))*$var(BD_SK_SENS_WR)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_SK_EFFECT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_SK_EFFECT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WR_MARGIN]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WR_MARGIN)]]
...
#############################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_ac_analysis {opcname inst pin_array_name var_array_name summary_name} {
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter AC_UI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(AC_UI)]]

   set var(CA_ISI) $var(CA_ISI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_ISI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_ISI)]]

   set var(CA_SSO) $var(CA_SSO)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_SSO]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_SSO)]]

   set var(CA_IS) [expr $var(tIS)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_IS]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_IS)]]

   set var(CA_IH) [expr $var(tIH)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_IH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_IH)]]

   set var(CA_MPR) [expr ($var(WITH_CA_CALIB) == 1 ? ($var(NUM_RANKS) == 1 ? ($var(WITH_MPR) == 1 ? -$var(CA_IS)*$var(MPR_IS) - $var(CA_IH)*$var(MPR_IH) : 0) : 0) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_MPR]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_MPR)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_JITTER]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_JITTER)]]

   set var(CA_DCD) $var(CA_DCD)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_DCD]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_DCD)]]

   set var(CA_EOL) $var(CA_EOL)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_EOL]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_EOL)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_CAL_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_CAL_UNC)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_PVT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_PVT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_SK_EFFECT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_SK_EFFECT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter CA_MARGIN]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(CA_MARGIN)]]
...
#############################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_dqs_gating_analysis  {opcname inst pin_array_name var_array_name summary_name} {
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_UI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_UI)]]

   set var(DQSG_ISI) $var(DQSG_ISI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_ISI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_ISI)]]

   set var(DQSG_SSI) $var(DQSG_SSI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_SSI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_SSI)]]

   set var(DQSG_DQSCK) [expr (([string compare $var(PROTOCOL) "LPDDR3"] == 0) ? $var(tDQSCK) : $var(tDQSCK)*2)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_DQSCK]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_DQSCK)]]

   set var(DQSG_MPR) [expr ($var(WITH_MPR) == 1 ? -$var(DQSG_DQSCK)*$var(MPR_DQSCK) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_MPR]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_MPR)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_JITTER]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_JITTER)]]

   set var(DQSG_DCD) $var(DQSG_DCD)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_DCD]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_DCD)]]

   set var(DQSG_EOL) $var(DQSG_EOL)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_EOL]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_EOL)]]

   set var(DQSG_CAL_UNC) $var(DQSG_CAL_UNC)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_CAL_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_CAL_UNC)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_TRK_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_TRK_UNC)]]

   set var(DQSG_SH) $var(DQSG_SH)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_SH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_SH)]]

   set var(DQSG_SK_EFFECT) [expr ($var(BD_PKG_SKEW)-$var(DEFAULT_BD_PKG_SKEW))*$var(BD_SK_SENS_DQSG)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_SK_EFFECT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_SK_EFFECT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter DQSG_MARGIN]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(DQSG_MARGIN)]]
...
#############################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_write_levelling_analysis  {opcname inst pin_array_name var_array_name summary_name} {
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_UI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_UI)]]

   set var(WL_ISI) $var(WL_ISI)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_ISI]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_ISI)]]

   set var(WL_SSO) $var(WL_SSO)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_SSO]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_SSO)]]

   set var(WL_MEM) [expr $var(tCK)*(1-2*[min [expr $var(tDQSS)] [expr (1-$var(tDSS)-$var(tDSH))/2]])]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_MEM]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_MEM)]]

   set var(WL_MPR) [expr ($var(WITH_WL_CALIB) == 1 ? ($var(WITH_MPR) == 1 ? -$var(WL_MEM)*$var(MPR_DQSS) : 0) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_MPR]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_MPR)]]

   set var(WL_SH) [expr ($var(WITH_WL_M_CALIB) == 1 ? (1-$var(MPR_WLS))*$var(tWLS) + (1-$var(MPR_WLH))*$var(tWLH) : 0)]
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_SH]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_SH)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_JITTER]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_JITTER)]]

   set var(WL_DCD) $var(WL_DCD)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_DCD]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_DCD)]]

   set var(WL_EOL) $var(WL_EOL)
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_EOL]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_EOL)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_CAL_UNC]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_CAL_UNC)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_PVT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_PVT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_SK_EFFECT]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_SK_EFFECT)]]
   ...
   lappend summary [list "   [emiftcl_get_parameter_user_string -parameter WL_MARGIN]" [mem1_altera_emif_arch_nd_191_ok5gedq_format_3dp $var(WL_MARGIN)]]
...
################################################################
proc mem1_altera_emif_arch_nd_191_ok5gedq_add_report_timing_analysis {opcname inst var_array_name summary_name title from_clks to_clks from_nodes to_nodes } {
...
proc mem1_altera_emif_arch_nd_191_ok5gedq_add_c2p_p2c_report_timing_analysis {opcname inst pin_array_name var_array_name summary_name title from_clks to_clks from_nodes to_nodes p2c} {
...
proc mem1_altera_emif_arch_nd_191_ok5gedq_perform_core_analysis {opcname inst pin_array_name var_array_name summary_name} {
   ...
   if {$::io_only_analysis == 1} {
      ...
      set coreclkname [list ${master_instname}_core_usr_* ${master_instname}_core_afi_* ${master_instname}_core_dft_* ${master_instname}_ref_clock ${master_instname}_core_nios_clk [mem1_altera_emif_arch_nd_191_ok5gedq_get_clock_name_from_pin_name $pins(pll_ref_clock)]]
      ...
      # Core-to-periphery
      set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_c2p_p2c_report_timing_analysis $opcname $inst $pin_array_name var global_summary "Core To Periphery" $coreclks $phyclks "*" $emif_regs 0]
      ...
      # Periphery-to-core
      set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_c2p_p2c_report_timing_analysis $opcname $inst $pin_array_name var global_summary "Periphery To Core" $phyclks $coreclks $emif_regs "*" 1]
      set setup_margin    [min $setup_margin    [lindex $res 0]]
      set hold_margin     [min $hold_margin     [lindex $res 1]]
      set recovery_margin [min $recovery_margin [lindex $res 2]]
      set removal_margin  [min $removal_margin  [lindex $res 3]]
      ...
      set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_report_timing_analysis $opcname $inst var global_summary "Within Core" $coreclks $coreclks $emif_regs $emif_regs]
      set setup_margin    [min $setup_margin    [lindex $res 0]]
      set hold_margin     [min $hold_margin     [lindex $res 1]]
      set recovery_margin [min $recovery_margin [lindex $res 2]]
      set removal_margin  [min $removal_margin  [lindex $res 3]]
      ...
      set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_report_timing_analysis $opcname $inst var global_summary "IP to User Logic" "*" "*" $emif_regs $rest_regs]
      set setup_margin    [min $setup_margin    [lindex $res 0]]
      set hold_margin     [min $hold_margin     [lindex $res 1]]
      set recovery_margin [min $recovery_margin [lindex $res 2]]
      set removal_margin  [min $removal_margin  [lindex $res 3]]
      ...
      set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_report_timing_analysis $opcname $inst var global_summary "User Logic to IP" "*" "*" $rest_regs $emif_regs]
      set setup_margin    [min $setup_margin    [lindex $res 0]]
      set hold_margin     [min $hold_margin     [lindex $res 1]]
      set recovery_margin [min $recovery_margin [lindex $res 2]]
      set removal_margin  [min $removal_margin  [lindex $res 3]]
      ...
      if {$var(DIAG_TIMING_REGTEST_MODE)} {
         set res [mem1_altera_emif_arch_nd_191_ok5gedq_add_report_timing_analysis $opcname $inst var global_summary "Within User Logic" $coreclks $coreclks $rest_regs $rest_regs]
         set setup_margin    [min $setup_margin    [lindex $res 0]]
         set hold_margin     [min $hold_margin     [lindex $res 1]]
         set recovery_margin [min $recovery_margin [lindex $res 2]]
         set removal_margin  [min $removal_margin  [lindex $res 3]]
