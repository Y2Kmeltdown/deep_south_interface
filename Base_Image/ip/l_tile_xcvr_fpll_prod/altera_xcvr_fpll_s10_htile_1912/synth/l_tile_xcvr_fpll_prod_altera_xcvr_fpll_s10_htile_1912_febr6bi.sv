...
module l_tile_xcvr_fpll_prod_altera_xcvr_fpll_s10_htile_1912_febr6bi
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_febr6bi 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_febr6bi phase_en_pulse(
        ...
        dps_reset_gen_febr6bi dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
