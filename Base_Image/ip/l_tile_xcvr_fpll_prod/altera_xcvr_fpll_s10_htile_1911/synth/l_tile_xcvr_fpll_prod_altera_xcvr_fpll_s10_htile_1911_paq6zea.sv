...
module l_tile_xcvr_fpll_prod_altera_xcvr_fpll_s10_htile_1911_paq6zea
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_paq6zea 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_paq6zea phase_en_pulse(
        ...
        dps_reset_gen_paq6zea dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
