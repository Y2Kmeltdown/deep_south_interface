...
// length_info: 1
// cmd_info: 32'b00010000000000000001000000011001 32'h00000000
// debug: 0
// -------------------------------------------------------

`timescale 1 ns / 1 ns
module s10_temperature_altera_s10_mailbox_pro_client_lite_191_i62yemi #(
    ...
    assign cmd_header = 32'b00010000000000000001000000011001;
    ...
    // +----------------------------------------------------------------------
    s10_temperature_altera_s10_mailbox_pro_client_lite_191_i62yemi_response_pck_process #(
        // user 16, as the voltage sensor use 16 channels, 
        .REQ_WIDTH   (16)
    ) s10_temperature_altera_s10_mailbox_pro_client_lite_191_i62yemi_response_pck_process_0 (
        .clk                    (clk),
        .reset                  (reset),
...
// +--------------------------------------------------
module s10_temperature_altera_s10_mailbox_pro_client_lite_191_i62yemi_response_pck_process #(
