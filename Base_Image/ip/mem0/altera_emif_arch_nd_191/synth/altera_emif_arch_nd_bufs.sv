...
`define _get_lane_index_in_tile(_loc, _port_i) ( ((`_get_pin_index(_loc, _port_i) / PINS_PER_LANE) % 4) )
...
module altera_emif_arch_nd_bufs #(
   ...
   parameter PORT_MEM_GNT_N_PINLOC                   = 10'b0000000000,
   parameter PORT_MEM_REQ_N_PINLOC                   = 10'b0000000000,
   parameter PORT_MEM_ERR_N_PINLOC                   = 10'b0000000000,
   ...
   generate
      ...
      if (`_get_pin_count(PORT_MEM_GNT_N_PINLOC) != 0) begin : gen_mem_gnt_n
         for (port_i = 0; port_i < PORT_MEM_GNT_N_WIDTH; ++port_i)
         begin : inst
            altera_emif_arch_nd_buf_udir_se_o # (
               .OCT_CONTROL_WIDTH(OCT_CONTROL_WIDTH),
               .CALIBRATED_OCT(PHY_AC_CALIBRATED_OCT)
            ) b (
               .i(l2b_data[`_get_pin_index(PORT_MEM_GNT_N_PINLOC, port_i)]),
               .o(mem_gnt_n[port_i]),
               .oe(l2b_oe[`_get_pin_index(PORT_MEM_GNT_N_PINLOC, port_i)]),
               .emif_phy_in_a(l2b_e_a[`_get_pin_index(PORT_MEM_GNT_N_PINLOC, port_i)]),
               .emif_phy_in_b(l2b_e_b[`_get_pin_index(PORT_MEM_GNT_N_PINLOC, port_i)]),
               .oct_stc(oct_stc),
               .oct_ptc(oct_ptc)
            );

            altera_emif_arch_nd_buf_unused ubuf (.o(b2l_data[`_get_pin_index(PORT_MEM_GNT_N_PINLOC, port_i)]));
         end
      end else begin : no_mem_gnt_n
         assign mem_gnt_n = '0;
      end
      ...
      if (`_get_pin_count(PORT_MEM_ALERT_N_PINLOC) != 0) begin : gen_mem_alert_n
         ...
         begin : inst
            altera_emif_arch_nd_buf_udir_se_i # (
               .OCT_CONTROL_WIDTH(OCT_CONTROL_WIDTH),
               .CALIBRATED_OCT((PROTOCOL_ENUM == "PROTOCOL_DDR4" ||PROTOCOL_ENUM == "PROTOCOL_DDRT" ) ? 0 : PHY_DATA_CALIBRATED_OCT)
            ) b (
      ...
      if (`_get_pin_count(PORT_MEM_REQ_N_PINLOC) != 0) begin : gen_mem_req_n
         for (port_i = 0; port_i < PORT_MEM_REQ_N_WIDTH; ++port_i)
         begin : inst
            altera_emif_arch_nd_buf_udir_se_i # (
               .OCT_CONTROL_WIDTH(OCT_CONTROL_WIDTH),
               .CALIBRATED_OCT(1)
               ...
               .i(mem_req_n[port_i]),
               .o(b2l_data[`_get_pin_index(PORT_MEM_REQ_N_PINLOC, port_i)]),
               .oct_stc(oct_stc),
               .oct_ptc(oct_ptc)
            );
         end
      ...
      if (`_get_pin_count(PORT_MEM_ERR_N_PINLOC) != 0) begin : gen_mem_err_n
         for (port_i = 0; port_i < PORT_MEM_ERR_N_WIDTH; ++port_i)
         begin : inst
            altera_emif_arch_nd_buf_udir_se_i # (
               .OCT_CONTROL_WIDTH(OCT_CONTROL_WIDTH),
               .CALIBRATED_OCT(1)
               ...
               .i(mem_err_n[port_i]),
               .o(b2l_data[`_get_pin_index(PORT_MEM_ERR_N_PINLOC, port_i)]),
               .oct_stc(oct_stc),
               .oct_ptc(oct_ptc)
            );
         end
      ...
      if (`_get_pin_count(PORT_MEM_CK_PINLOC) != 0) begin : gen_mem_ck
         if (PROTOCOL_ENUM == "PROTOCOL_DDRT") begin
            wire logic [PORT_MEM_CK_WIDTH-1:0]                       mem_ck_int;
            wire logic [PORT_MEM_CK_N_WIDTH-1:0]                     mem_ck_n_int;
            assign mem_ck   = mem_ck_int;
            assign mem_ck_n = mem_ck_n_int;
            ...
            begin : inst
               ...
               altera_emif_arch_nd_buf_bdir_df # (
                  ...
                  .io(mem_ck_int[port_i]),
                  .iobar(mem_ck_n_int[port_i]),
                  .ibuf_o(sig),
                  .obuf_i(l2b_data[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i)]),
                  .obuf_ibar(l2b_data[`_get_pin_index(PORT_MEM_CK_N_PINLOC, port_i)]),
                  .obuf_oe(l2b_oe[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i)]),
                  .obuf_oebar(l2b_oe[`_get_pin_index(PORT_MEM_CK_N_PINLOC, port_i)]),
                  .obuf_dtc('0),
                  .obuf_dtcbar('0),
               ...
               if (`_get_lane_index_in_tile(PORT_MEM_CK_PINLOC, port_i) > 1) begin : gen_ddrt_ac_x4
                  assign b2t_dqsb[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i) / PINS_PER_LANE] = sig;

                  altera_emif_arch_nd_buf_unused ub0 (.o(b2t_dqs[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i) / PINS_PER_LANE]));

               end else begin : gen_ddrt_ac_x18
                  assign b2t_dqs[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i) / PINS_PER_LANE] = sig;

                  altera_emif_arch_nd_buf_unused ub0 (.o(b2t_dqsb[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i) / PINS_PER_LANE]));
               end

               assign b2l_data[`_get_pin_index(PORT_MEM_CK_PINLOC, port_i)] = sig;
