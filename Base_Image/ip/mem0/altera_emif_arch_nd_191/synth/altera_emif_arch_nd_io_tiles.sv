...
`define _is_ac_lane(_tile_i, _lane_i)                    ( `_get_lane_usage(_tile_i, _lane_i) == LANE_USAGE_AC_CORE )
...
`define _connect_ddrt_ac_dqs_x4(_tile_i, _lane_i)  (_lane_i >= 2)
`define _connect_ddrt_ac_dqs_x8(_tile_i, _lane_i)  (0)
`define _connect_ddrt_ac_dqs_x18(_tile_i, _lane_i) (_lane_i <  2)
`define _connect_ddrt_ac_dqs_x36(_tile_i, _lane_i) (0)

`define _connect_dqs_x4(_tile_i, _lane_i)  ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(_tile_i, _lane_i)) ? `_connect_ddrt_ac_dqs_x4(_tile_i, _lane_i)  : (DQS_BUS_MODE_ENUM == "DQS_BUS_MODE_X4"))
`define _connect_dqs_x8(_tile_i, _lane_i)  ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(_tile_i, _lane_i)) ? `_connect_ddrt_ac_dqs_x8(_tile_i, _lane_i)  : (DQS_BUS_MODE_ENUM == "DQS_BUS_MODE_X8_X9"))
`define _connect_dqs_x18(_tile_i, _lane_i) ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(_tile_i, _lane_i)) ? `_connect_ddrt_ac_dqs_x18(_tile_i, _lane_i) : (DQS_BUS_MODE_ENUM == "DQS_BUS_MODE_X16_X18"))
`define _connect_dqs_x36(_tile_i, _lane_i) ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(_tile_i, _lane_i)) ? `_connect_ddrt_ac_dqs_x36(_tile_i, _lane_i) : (DQS_BUS_MODE_ENUM == "DQS_BUS_MODE_X32_X36"))

`define _get_pin_dqs_mode_str_ddrt_ac(_tile_i, _lane_i, _pin_i) ( _lane_i > 1 ? "dqs_sampler_b" : "dqs_sampler_a" )

`define _get_pin_dqs_mode_str(_tile_i, _lane_i, _pin_i)   ( (PROTOCOL_ENUM == "PROTOCOL_QDR2")                       ?  "dqs_sampler_b_a_rise" :  ( \
                                                            (PROTOCOL_ENUM == "PROTOCOL_DDRT") && (`_is_ac_lane(_tile_i, _lane_i)) ? `_get_pin_dqs_mode_str_ddrt_ac(_tile_i, _lane_i, _pin_i) : ( \
...
`define _get_hmc_ctrl_mem_type                           ( PROTOCOL_ENUM == "PROTOCOL_DDR3"   ? "mem_type_ddr3"   : ( \
                                                           ...
                                                           PROTOCOL_ENUM == "PROTOCOL_DDRT"   ? "mem_type_ddr4"   : ( \
...
`define _get_dqsin(_tile_i, _lane_i)                     ( (`_get_lane_usage(_tile_i, _lane_i) != LANE_USAGE_RDATA && `_get_lane_usage(_tile_i, _lane_i) != LANE_USAGE_WDATA && `_get_lane_usage(_tile_i, _lane_i) != LANE_USAGE_WRDATA) ? \
                                                          ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_get_lane_usage(_tile_i, _lane_i) == LANE_USAGE_AC_CORE ) ? ( _lane_i > 1 ? t2l_dqsbus_x4[_lane_i] : t2l_dqsbus_x18[_lane_i]) : 2'b0 ) : ( \
...
`define _get_preamble_track_dqs_enable_mode              ( PROTOCOL_ENUM == "PROTOCOL_DDR4"   ? "preamble_track_dqs_enable" : ( \
                                                           PROTOCOL_ENUM == "PROTOCOL_DDRT"   ? "preamble_track_dqs_enable" : ( \
...
`define _get_pst_preamble_mode                           ( PROTOCOL_ENUM == "PROTOCOL_DDR4"   ? "ddr4_preamble" : ( \
                                                           PROTOCOL_ENUM == "PROTOCOL_DDRT"   ? "ddr4_preamble" : ( \
...
`define _get_pin_pair_mode                               ( PROTOCOL_ENUM == "PROTOCOL_DDR4"   ? "ddr4_idle" : ( \
                                                           PROTOCOL_ENUM == "PROTOCOL_DDRT"   ? "ddr4_idle" : ( \
...
`define _get_pst_en_shrink                               ( PROTOCOL_ENUM == "PROTOCOL_DDR4"   ? "shrink_1_0" : ( \
                                                           PROTOCOL_ENUM == "PROTOCOL_DDRT"   ? "shrink_1_0" : ( \
...
`define _get_x18_0_lane       ((`_use_reva_x18_dqstree == 1) ? 1 : 0 )
`define _get_x18_1_lane       ((`_use_reva_x18_dqstree == 1) ? 3 : 2 )

// Historically, this parameter has not been set in the lane atom. Since it was not set, it defaulted to DDR3.
// However, for DDR-T, we require different fitter behaviour, so we set it to DDR-T only when we need that behaviour,
// and DDR3 for all other protocols.
`define _get_lane_memory_protocol                        ( PROTOCOL_ENUM == "PROTOCOL_DDRT" ? "protocol_ddrt" : \
                                                                                              "protocol_ddr3" )
...
module altera_emif_arch_nd_io_tiles #(
   ...
   output logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_a_nonabphy,          
   output logic [PINS_IN_RTL_TILES-1:0]                                                          l2b_e_b_nonabphy,          
   ...
   generate
      ...
      begin: tile_gen
         ...
         // Tie-off signals
         logic             tile_pa_reset_n;
         logic [11:0]      tile_pa_core_in;
         logic             tile_pa_dprio_rst_n;
         logic             tile_pa_dprio_clk;
         logic             tile_pa_dprio_read;
         logic [8:0]       tile_pa_dprio_reg_addr;
         logic             tile_pa_dprio_write;
         logic [7:0]       tile_pa_dprio_writedata;

         assign tile_pa_reset_n           = IS_HPS ? 1'b1          : (DIAG_USE_ABSTRACT_PHY == 1 ? (~core2seq_reset_req) : 1'b1);
         assign tile_pa_core_in           = IS_HPS ? 12'hFFF       : 12'h000;
         assign tile_pa_dprio_rst_n       = IS_HPS ? 1'b1          : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_rst_n : 1'b0);
         assign tile_pa_dprio_clk         = IS_HPS ? 1'b1          : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_clk : 1'b0);
         assign tile_pa_dprio_read        = IS_HPS ? 1'b1          : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_read : 1'b0);
         assign tile_pa_dprio_reg_addr    = IS_HPS ? 9'b1_1111_111 : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_reg_addr : 9'b0);
         assign tile_pa_dprio_write       = IS_HPS ? 1'b1          : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_write : 1'b0);
         assign tile_pa_dprio_writedata   = IS_HPS ? 8'b1111_1111  : (tile_i == PRI_AC_TILE_INDEX ? pa_dprio_writedata : 8'b0);
         ...
         fourteennm_tile_ctrl # (
            ...
            .pa_reset_n                       (tile_pa_reset_n),                    // Connected to global reset from core in non-HPS mode
            .pa_core_in                       (tile_pa_core_in),                    // Control code word
            ...
            .pa_dprio_rst_n                   (tile_pa_dprio_rst_n),
            .pa_dprio_clk                     (tile_pa_dprio_clk),
            .pa_dprio_read                    (tile_pa_dprio_read),
            .pa_dprio_reg_addr                (tile_pa_dprio_reg_addr),
            .pa_dprio_write                   (tile_pa_dprio_write),
            .pa_dprio_writedata               (tile_pa_dprio_writedata),
            ...
            .dqs_in_x4_a_0                    (`_connect_dqs_x4(tile_i, 0) ? b2t_dqs[(tile_i * LANES_PER_TILE) + 0] : 1'b0),
            .dqs_in_x4_a_1                    (`_connect_dqs_x4(tile_i, 1) ? b2t_dqs[(tile_i * LANES_PER_TILE) + 1] : 1'b0),
            .dqs_in_x4_a_2                    (`_connect_dqs_x4(tile_i, 2) ? b2t_dqs[(tile_i * LANES_PER_TILE) + 2] : 1'b0),
            .dqs_in_x4_a_3                    (`_connect_dqs_x4(tile_i, 3) ? b2t_dqs[(tile_i * LANES_PER_TILE) + 3] : 1'b0),
            .dqs_in_x4_b_0                    (`_connect_dqs_x4(tile_i, 0) ? b2t_dqsb[(tile_i * LANES_PER_TILE) + 0] : 1'b0),
            .dqs_in_x4_b_1                    (`_connect_dqs_x4(tile_i, 1) ? b2t_dqsb[(tile_i * LANES_PER_TILE) + 1] : 1'b0),
            .dqs_in_x4_b_2                    (`_connect_dqs_x4(tile_i, 2) ? b2t_dqsb[(tile_i * LANES_PER_TILE) + 2] : 1'b0),
            .dqs_in_x4_b_3                    (`_connect_dqs_x4(tile_i, 3) ? b2t_dqsb[(tile_i * LANES_PER_TILE) + 3] : 1'b0),
            ...
            .dqs_in_x8_0                      (`_connect_dqs_x8(tile_i, 0) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + 0], b2t_dqs[(tile_i * LANES_PER_TILE) + 0]} : 2'b0),
            .dqs_in_x8_1                      (`_connect_dqs_x8(tile_i, 1) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + 1], b2t_dqs[(tile_i * LANES_PER_TILE) + 1]} : 2'b0),
            .dqs_in_x8_2                      (`_connect_dqs_x8(tile_i, 2) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + 2], b2t_dqs[(tile_i * LANES_PER_TILE) + 2]} : 2'b0),
            .dqs_in_x8_3                      (`_connect_dqs_x8(tile_i, 3) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + 3], b2t_dqs[(tile_i * LANES_PER_TILE) + 3]} : 2'b0),
            ...
            .dqs_in_x18_0                     (`_connect_dqs_x18(tile_i, `_get_x18_0_lane) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + `_get_x18_0_lane], b2t_dqs[(tile_i * LANES_PER_TILE) + `_get_x18_0_lane]} : 2'b0),
            .dqs_in_x18_1                     (`_connect_dqs_x18(tile_i, `_get_x18_1_lane) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + `_get_x18_1_lane], b2t_dqs[(tile_i * LANES_PER_TILE) + `_get_x18_1_lane]} : 2'b0),
            ...
            .dqs_in_x36                       (`_connect_dqs_x36(tile_i, 1) ? {b2t_dqsb[(tile_i * LANES_PER_TILE) + 1], b2t_dqs[(tile_i * LANES_PER_TILE) + 1]} : 2'b0),
         ...
         begin: lane_gen
            ...
            altera_emif_arch_nd_io_lane_remap #(
               ...
               .rd_valid_delay                              ((PROTOCOL_ENUM == "PROTOCOL_DDRT") ? 7'b0001100 : 7'b0000000),    // Don't-care - always set by calibration software
               ...
               .dqs_lgc_pack_mode                           ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(tile_i, 0)) ? "not_packed" : DQS_PACK_MODE),
               ...
               // This enables read capture using an internal clock - never used by EMIF
               .dqs_lgc_dqs_a_interp_en                     ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(tile_i, lane_i)) ? ((lane_i > 1) ? "dqsa_constant"  : "dqsa_diff_in_2") : DQSA_LGC_MODE),
               .dqs_lgc_dqs_b_interp_en                     ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(tile_i, lane_i)) ? ((lane_i > 1) ? "dqsb_diff_in_1" : "dqsb_constant" ) : DQSB_LGC_MODE),
               .mrnk_write_mode                             (`_get_mrnk_write_mode(tile_i, lane_i)),

               // Inform the fitter of the memory protocol.
               .memory_protocol                             (`_get_lane_memory_protocol)
               ...
               .core_dll                                 (3'b100),    
               .dll_core                                 (),    
               .ioereg_locked                            (l2core_ioereg_locked[tile_i][lane_i]),
               ...
               .emif_phy_out_a                           (l2b_e_a_nonabphy[tile_i * PINS_PER_LANE * LANES_PER_TILE + lane_i * PINS_PER_LANE +: PINS_PER_LANE]),
               .emif_phy_out_b                           (l2b_e_b_nonabphy[tile_i * PINS_PER_LANE * LANES_PER_TILE + lane_i * PINS_PER_LANE +: PINS_PER_LANE]),
               ...
               .rdata_en_full_core                       ((`_get_lane_usage(tile_i, lane_i) == LANE_USAGE_RDATA || `_get_lane_usage(tile_i, lane_i) == LANE_USAGE_WRDATA) ? core2l_rdata_en_full[tile_i][lane_i] : ((PROTOCOL_ENUM == "PROTOCOL_DDRT" && `_is_ac_lane(tile_i, lane_i)) ? core2l_rdata_en_full[tile_i][lane_i] : 4'b0)),
