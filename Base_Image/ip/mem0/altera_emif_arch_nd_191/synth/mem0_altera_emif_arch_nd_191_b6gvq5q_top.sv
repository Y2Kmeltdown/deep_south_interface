...
//
///////////////////////////////////////////////////////////////////////////////
module mem0_altera_emif_arch_nd_191_b6gvq5q_top #(
   ...
   // Mem Bypass parameters
   parameter DIAG_SIM_MEM_BYPASS_DQ_WIDTH            = 512,
   parameter DIAG_SIM_MEM_BYPASS_ADDR_WIDTH          = 64,
   ...
   initial begin
      ...
      assert(PORT_MEM_GNT_N_PINLOC_AUTOGEN_WCNT       == 6) else $fatal(1, "PORT_MEM_GNT_N_PINLOC_AUTOGEN_WCNT != 6 - Parameter definitions in RTL and Tcl generation code are out of sync!");
      assert(PORT_MEM_REQ_N_PINLOC_AUTOGEN_WCNT       == 6) else $fatal(1, "PORT_MEM_REQ_N_PINLOC_AUTOGEN_WCNT != 6 - Parameter definitions in RTL and Tcl generation code are out of sync!");
      assert(PORT_MEM_ERR_N_PINLOC_AUTOGEN_WCNT       == 6) else $fatal(1, "PORT_MEM_ERR_N_PINLOC_AUTOGEN_WCNT != 6 - Parameter definitions in RTL and Tcl generation code are out of sync!");
   ...
   localparam PORT_MEM_GNT_N_PINLOC         = {PORT_MEM_GNT_N_PINLOC_5[29:0],PORT_MEM_GNT_N_PINLOC_4[29:0],PORT_MEM_GNT_N_PINLOC_3[29:0],PORT_MEM_GNT_N_PINLOC_2[29:0],PORT_MEM_GNT_N_PINLOC_1[29:0],PORT_MEM_GNT_N_PINLOC_0[29:0]};
   localparam PORT_MEM_REQ_N_PINLOC         = {PORT_MEM_REQ_N_PINLOC_5[29:0],PORT_MEM_REQ_N_PINLOC_4[29:0],PORT_MEM_REQ_N_PINLOC_3[29:0],PORT_MEM_REQ_N_PINLOC_2[29:0],PORT_MEM_REQ_N_PINLOC_1[29:0],PORT_MEM_REQ_N_PINLOC_0[29:0]};
   localparam PORT_MEM_ERR_N_PINLOC         = {PORT_MEM_ERR_N_PINLOC_5[29:0],PORT_MEM_ERR_N_PINLOC_4[29:0],PORT_MEM_ERR_N_PINLOC_3[29:0],PORT_MEM_ERR_N_PINLOC_2[29:0],PORT_MEM_ERR_N_PINLOC_1[29:0],PORT_MEM_ERR_N_PINLOC_0[29:0]};
   ...
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][5:0]                                    l2core_ioereg_locked;

   // Wires for wire-luts
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][PINS_PER_LANE * 8 - 1:0]                actual_core2l_data;
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][PINS_PER_LANE * 4 - 1:0]                actual_core2l_oe;
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][3:0]                                    actual_core2l_rdata_en_full;
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][15:0]                                   actual_core2l_mrnk_read;
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][15:0]                                   actual_core2l_mrnk_write;
   logic                                                                                    actual_core2l_wr_data_vld_ast_0;
   logic                                                                                    actual_core2l_wr_data_vld_ast_1;
   logic                                                                                    actual_core2l_rd_data_rdy_ast_0;
   logic                                                                                    actual_core2l_rd_data_rdy_ast_1;
   logic [12:0]                                                                             actual_core2l_wr_ecc_info_0;
   logic [12:0]                                                                             actual_core2l_wr_ecc_info_1;
   ...
   logic [PINS_IN_RTL_TILES-1:0]                                                            l2b_e_a;      // lane-to-buffer emif_phy_out_a signal
   logic [PINS_IN_RTL_TILES-1:0]                                                            l2b_e_b;      // lane-to-buffer emif_phy_out_b signal
   ...
   wire cal_debug_reset_n_io_ssm_in;
   wire cal_slave_reset_n_in_io_ssm_in;
...
`endif
   ...
   ////////////////////////////////////////////////////////////////////////////
   altera_emif_arch_nd_local_reset # (
      .PHY_CONFIG_ENUM                     (PHY_CONFIG_ENUM),
      .IS_HPS                              (IS_HPS)
   ) local_reset_inst (
      .*
   ...
   altera_emif_arch_nd_bufs # (
      ...
      .PORT_MEM_GNT_N_PINLOC               (PORT_MEM_GNT_N_PINLOC),
      .PORT_MEM_REQ_N_PINLOC               (PORT_MEM_REQ_N_PINLOC),
      .PORT_MEM_ERR_N_PINLOC               (PORT_MEM_ERR_N_PINLOC),
   ...
   // I/O Aux
   ////////////////////////////////////////////////////////////////////////////
   mem0_altera_emif_arch_nd_191_b6gvq5q_io_ssm # (
      ...
      .DIAG_EXPORT_SEQ_AVALON_HEAD_OF_CHAIN (DIAG_EXPORT_SEQ_AVALON_HEAD_OF_CHAIN)
   ) io_ssm_inst (
      .cal_debug_reset_n                    (cal_debug_reset_n_io_ssm_in),
      .cal_slave_reset_n_in                 (cal_slave_reset_n_in_io_ssm_in),
      .*
   );
   ...
   // Tiles and Lanes
   ////////////////////////////////////////////////////////////////////////////
   altera_emif_arch_nd_io_tiles_wrap # (
      .DIAG_SYNTH_FOR_SIM                   (DIAG_SYNTH_FOR_SIM),
      .DIAG_CPA_OUT_1_EN                    (DIAG_CPA_OUT_1_EN),
      ...
      .HMC_CFG_ADDR_ORDER                   (PRI_HMC_CFG_ADDR_ORDER),   
      .HMC_CFG_CS_ADDR_WIDTH                (PRI_HMC_CFG_CS_ADDR_WIDTH),
      .HMC_CFG_ROW_ADDR_WIDTH               (PRI_HMC_CFG_ROW_ADDR_WIDTH)
   ) io_tiles_wrap_inst (
      ...
      .core2l_wr_ecc_info_0     (actual_core2l_wr_ecc_info_0),
      .core2l_wr_ecc_info_1     (actual_core2l_wr_ecc_info_1),
      .core2l_wr_data_vld_ast_0 (actual_core2l_wr_data_vld_ast_0),
      .core2l_wr_data_vld_ast_1 (actual_core2l_wr_data_vld_ast_1),
      .core2l_rd_data_rdy_ast_0 (actual_core2l_rd_data_rdy_ast_0),
      .core2l_rd_data_rdy_ast_1 (actual_core2l_rd_data_rdy_ast_1),
      .*
   );
   ...
   begin : nonabphy_connections
      assign cal_debug_reset_n_io_ssm_in    = cal_debug_reset_n;
      assign cal_slave_reset_n_in_io_ssm_in = cal_slave_reset_n_in;
   end
   else begin : abphy_connections
      assign cal_debug_reset_n_io_ssm_in    = runAbstractPhySim==0 ? cal_debug_reset_n    : 'b0;
      assign cal_slave_reset_n_in_io_ssm_in = runAbstractPhySim==0 ? cal_slave_reset_n_in : 'b0;
   end
   endgenerate

   ////////////////////////////////////////////////////////////////////////////
   // Wireluts for timing closure
   ////////////////////////////////////////////////////////////////////////////
   generate
      genvar tile_i, lane_i, pin_i, sig_i, lut_i;

      if ((WIRELUTS_FOR_C2P==0) || IS_HPS) begin : no_c2p_wluts
         assign actual_core2l_data              = core2l_data;
         assign actual_core2l_oe                = core2l_oe;
         assign actual_core2l_rdata_en_full     = core2l_rdata_en_full;
         assign actual_core2l_mrnk_read         = core2l_mrnk_read;
         assign actual_core2l_mrnk_write        = core2l_mrnk_write;
         assign actual_core2l_wr_ecc_info_0     = core2l_wr_ecc_info_0;
         assign actual_core2l_wr_ecc_info_1     = core2l_wr_ecc_info_1;
         assign actual_core2l_wr_data_vld_ast_0 = core2l_wr_data_vld_ast_0;
         assign actual_core2l_wr_data_vld_ast_1 = core2l_wr_data_vld_ast_1;
         assign actual_core2l_rd_data_rdy_ast_0 = core2l_rd_data_rdy_ast_0;
         assign actual_core2l_rd_data_rdy_ast_1 = core2l_rd_data_rdy_ast_1;

      end else begin : c2p_wluts
         logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][PINS_PER_LANE * 8 - 1:0]  wlut_core2l_data /* synthesis dont_merge*/;
         logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][PINS_PER_LANE * 4 - 1:0]  wlut_core2l_oe /* synthesis dont_merge*/;
         logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][3:0]                      wlut_core2l_rdata_en_full /* synthesis dont_merge*/;
         logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][15:0]                     wlut_core2l_mrnk_read /* synthesis dont_merge*/;
         logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][15:0]                     wlut_core2l_mrnk_write /* synthesis dont_merge*/;

         assign actual_core2l_data              = wlut_core2l_data;
         assign actual_core2l_oe                = wlut_core2l_oe;
         assign actual_core2l_rdata_en_full     = wlut_core2l_rdata_en_full;
         assign actual_core2l_mrnk_read         = wlut_core2l_mrnk_read;
         assign actual_core2l_mrnk_write        = wlut_core2l_mrnk_write;

         for (tile_i = 0; tile_i < NUM_OF_RTL_TILES; ++tile_i)
         begin: tile_gen
            for (lane_i = 0; lane_i < LANES_PER_TILE; ++lane_i)
            begin: lane_gen
               for (pin_i = 0; pin_i < PINS_PER_LANE * 8; ++pin_i)
               begin: data_gen
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_i /* synthesis dont_merge*/;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_o /* synthesis dont_merge*/;

                  assign wlut_core2l_data[tile_i][lane_i][pin_i] = wlut_o[WIRELUTS_FOR_C2P-1];

                  for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
                  begin: wlut_gen
                     assign wlut_i[lut_i] = (lut_i == 0) ? core2l_data[tile_i][lane_i][pin_i] : wlut_o[lut_i-1];
                     fourteennm_lcell_comb # (
                        .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                        .dont_touch ("on")
                     ) wlut_inst (
                        .dataa   (wlut_i[lut_i]),
                        .combout (wlut_o[lut_i])
                     );
                  end
               ...
               for (pin_i = 0; pin_i < PINS_PER_LANE * 4; ++pin_i)
               begin: oe_gen
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_i /* synthesis dont_merge*/;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_o /* synthesis dont_merge*/;

                  assign wlut_core2l_oe[tile_i][lane_i][pin_i] = wlut_o[WIRELUTS_FOR_C2P-1];

                  for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
                  begin: wlut_gen
                     assign wlut_i[lut_i] = (lut_i == 0) ? core2l_oe[tile_i][lane_i][pin_i] : wlut_o[lut_i-1];
                     fourteennm_lcell_comb # (
                        .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                        .dont_touch ("on")
                     ) wlut_inst (
               ...
               for (sig_i = 0; sig_i < 4; ++sig_i)
               begin: rdata_en_full_gen
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_i;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_o;

                  assign wlut_core2l_rdata_en_full[tile_i][lane_i][sig_i] = wlut_o[WIRELUTS_FOR_C2P-1];

                  for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
                  begin: wlut_gen
                     assign wlut_i[lut_i] = (lut_i == 0) ? core2l_rdata_en_full[tile_i][lane_i][sig_i] : wlut_o[lut_i-1];
                     fourteennm_lcell_comb # (
                        .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                        .dont_touch ("on")
                     ) wlut_inst (
               ...
               for (sig_i = 0; sig_i < 16; ++sig_i)
               begin: mrnk_gen
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_mrnk_rd_i /* synthesis dont_merge*/;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_mrnk_rd_o /* synthesis dont_merge*/;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_mrnk_wr_i /* synthesis dont_merge*/;
                  logic [WIRELUTS_FOR_C2P-1:0] wlut_mrnk_wr_o /* synthesis dont_merge*/;

                  assign wlut_core2l_mrnk_read[tile_i][lane_i][sig_i]  = wlut_mrnk_rd_o[WIRELUTS_FOR_C2P-1];
                  assign wlut_core2l_mrnk_write[tile_i][lane_i][sig_i] = wlut_mrnk_wr_o[WIRELUTS_FOR_C2P-1];

                  for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
                  begin: wlut_mrnk_rd_gen
                     assign wlut_mrnk_rd_i[lut_i] = (lut_i == 0) ? core2l_mrnk_read[tile_i][lane_i][sig_i]
                                                                 : wlut_mrnk_rd_o[lut_i-1];
                     fourteennm_lcell_comb # (
                        .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                        .dont_touch ("on")
                     ) wlut_mrnk_rd_inst (
                        .dataa   (wlut_mrnk_rd_i[lut_i]),
                        .combout (wlut_mrnk_rd_o[lut_i])
                     );
                  end

                  for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
                  begin: wlut_mrnk_wr_gen
                     assign wlut_mrnk_wr_i[lut_i] = (lut_i == 0) ? core2l_mrnk_write[tile_i][lane_i][sig_i]
                                                                 : wlut_mrnk_wr_o[lut_i-1];
                     fourteennm_lcell_comb # (
                        .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                        .dont_touch ("on")
                     ) wlut_mrnk_wr_inst (
                        .dataa   (wlut_mrnk_wr_i[lut_i]),
                        .combout (wlut_mrnk_wr_o[lut_i])
                     );
                  end
               end
            end
         ...
         if (HMC_AVL_PROTOCOL_ENUM == "CTRL_AVL_PROTOCOL_ST") begin : ast
            logic        wlut_core2l_wr_data_vld_ast_0 /* synthesis dont_merge*/;
            logic        wlut_core2l_wr_data_vld_ast_1 /* synthesis dont_merge*/;
            logic        wlut_core2l_rd_data_rdy_ast_0 /* synthesis dont_merge*/;
            logic        wlut_core2l_rd_data_rdy_ast_1 /* synthesis dont_merge*/;
            logic [12:0] wlut_core2l_wr_ecc_info_0 /* synthesis dont_merge*/;
            logic [12:0] wlut_core2l_wr_ecc_info_1 /* synthesis dont_merge*/;



            for (sig_i = 0; sig_i < 13; ++sig_i)
            begin: ecc_gen

               logic [WIRELUTS_FOR_C2P-1:0] wlut_ecc_info_0_i /* synthesis dont_merge*/;
               logic [WIRELUTS_FOR_C2P-1:0] wlut_ecc_info_0_o /* synthesis dont_merge*/;
               logic [WIRELUTS_FOR_C2P-1:0] wlut_ecc_info_1_i /* synthesis dont_merge*/;
               logic [WIRELUTS_FOR_C2P-1:0] wlut_ecc_info_1_o /* synthesis dont_merge*/;

               assign wlut_core2l_wr_ecc_info_0[sig_i] = wlut_ecc_info_0_o[WIRELUTS_FOR_C2P-1];
               assign wlut_core2l_wr_ecc_info_1[sig_i] = wlut_ecc_info_1_o[WIRELUTS_FOR_C2P-1];


               for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
               begin: wlut_ecc_info_0
                  assign wlut_ecc_info_0_i[lut_i] = (lut_i == 0) ? core2l_wr_ecc_info_0[sig_i]
                                                                 : wlut_ecc_info_0_o[lut_i-1];
                  fourteennm_lcell_comb # (
                     .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                     .dont_touch ("on")
                  ) wlut_ecc_info_0_inst (
                     .dataa   (wlut_ecc_info_0_i[lut_i]),
                     .combout (wlut_ecc_info_0_o[lut_i])
                  );
               end

               for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
               begin: wlut_ecc_info_1
                  assign wlut_ecc_info_1_i[lut_i] = (lut_i == 0) ? core2l_wr_ecc_info_1[sig_i]
                                                                 : wlut_ecc_info_1_o[lut_i-1];

                  fourteennm_lcell_comb # (
                     .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                     .dont_touch ("on")
                  ) wlut_ecc_info_1_inst (
                     .dataa   (wlut_ecc_info_1_i[lut_i]),
                     .combout (wlut_ecc_info_1_o[lut_i])
                  );
               end
            end


            logic [WIRELUTS_FOR_C2P-1:0] wlut_wr_data_vld_ast_0_i /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_wr_data_vld_ast_0_o /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_wr_data_vld_ast_1_i /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_wr_data_vld_ast_1_o /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_rd_data_rdy_ast_0_i /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_rd_data_rdy_ast_0_o /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_rd_data_rdy_ast_1_i /* synthesis dont_merge*/;
            logic [WIRELUTS_FOR_C2P-1:0] wlut_rd_data_rdy_ast_1_o /* synthesis dont_merge*/;


            assign wlut_core2l_wr_data_vld_ast_0 = wlut_wr_data_vld_ast_0_o[WIRELUTS_FOR_C2P-1];
            assign wlut_core2l_wr_data_vld_ast_1 = wlut_wr_data_vld_ast_1_o[WIRELUTS_FOR_C2P-1];
            assign wlut_core2l_rd_data_rdy_ast_0 = wlut_rd_data_rdy_ast_0_o[WIRELUTS_FOR_C2P-1];
            assign wlut_core2l_rd_data_rdy_ast_1 = wlut_rd_data_rdy_ast_1_o[WIRELUTS_FOR_C2P-1];

            for (lut_i = 0; lut_i < WIRELUTS_FOR_C2P; ++lut_i)
            begin: wlut_ast

               assign wlut_wr_data_vld_ast_0_i[lut_i] = (lut_i == 0) ? core2l_wr_data_vld_ast_0
                                                                     : wlut_wr_data_vld_ast_0_o[lut_i-1];
               assign wlut_wr_data_vld_ast_1_i[lut_i] = (lut_i == 0) ? core2l_wr_data_vld_ast_1
                                                                     : wlut_wr_data_vld_ast_1_o[lut_i-1];

               assign wlut_rd_data_rdy_ast_0_i[lut_i] = (lut_i == 0) ? core2l_rd_data_rdy_ast_0
                                                                     : wlut_rd_data_rdy_ast_0_o[lut_i-1];
               assign wlut_rd_data_rdy_ast_1_i[lut_i] = (lut_i == 0) ? core2l_rd_data_rdy_ast_1
                                                                     : wlut_rd_data_rdy_ast_1_o[lut_i-1];


               fourteennm_lcell_comb # (
                  .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                  .dont_touch ("on")
               ) wlut_core2l_wr_data_vld_ast_0_inst (
                  .dataa   (wlut_wr_data_vld_ast_0_i[lut_i]),
                  .combout (wlut_wr_data_vld_ast_0_o[lut_i])
               );

               fourteennm_lcell_comb # (
                  .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                  .dont_touch ("on")
               ) wlut_core2l_wr_data_vld_ast_1_inst (
                  .dataa   (wlut_wr_data_vld_ast_1_i[lut_i]),
                  .combout (wlut_wr_data_vld_ast_1_o[lut_i])
               );
               
               fourteennm_lcell_comb # (
                  .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                  .dont_touch ("on")
               ) wlut_core2l_rd_data_rdy_ast_0_inst (
                  .dataa   (wlut_rd_data_rdy_ast_0_i[lut_i]),
                  .combout (wlut_rd_data_rdy_ast_0_o[lut_i])
               );

               fourteennm_lcell_comb # (
                  .lut_mask   (64'hAAAAAAAAAAAAAAAA),
                  .dont_touch ("on")
               ) wlut_core2l_rd_data_rdy_ast_1_inst (
                  .dataa   (wlut_rd_data_rdy_ast_1_i[lut_i]),
                  .combout (wlut_rd_data_rdy_ast_1_o[lut_i])
               );
            end
            
            assign actual_core2l_wr_ecc_info_0     = wlut_core2l_wr_ecc_info_0;
            assign actual_core2l_wr_ecc_info_1     = wlut_core2l_wr_ecc_info_1;
            assign actual_core2l_wr_data_vld_ast_0 = wlut_core2l_wr_data_vld_ast_0;
            assign actual_core2l_wr_data_vld_ast_1 = wlut_core2l_wr_data_vld_ast_1;
            assign actual_core2l_rd_data_rdy_ast_0 = wlut_core2l_rd_data_rdy_ast_0;
            assign actual_core2l_rd_data_rdy_ast_1 = wlut_core2l_rd_data_rdy_ast_1;
            
         end else begin : non_ast
            assign actual_core2l_wr_ecc_info_0     = core2l_wr_ecc_info_0;
            assign actual_core2l_wr_ecc_info_1     = core2l_wr_ecc_info_1;
            assign actual_core2l_wr_data_vld_ast_0 = core2l_wr_data_vld_ast_0;
            assign actual_core2l_wr_data_vld_ast_1 = core2l_wr_data_vld_ast_1;
   ...
   begin : hmc
      ...
      begin : amm
         if (GENERATE_PHYLITE)
         begin: phylite
            altera_emif_arch_nd_phylite_if # (
               .PINS_PER_LANE                        (PINS_PER_LANE),
               .LANES_PER_TILE                       (LANES_PER_TILE),
               .NUM_OF_RTL_TILES                     (NUM_OF_RTL_TILES),
               .PORT_MEM_D_PINLOC                    (PORT_MEM_D_PINLOC),
   ...
   altera_emif_arch_nd_cal_counter # (
      .IS_HPS (IS_HPS)
   ) cal_counter_inst (
      .*
   );
   ...
   // synthesis translate_off
   ////////////////////////////////////////////////////////////////////////////
   // Simulation memory preload: Translate EMIF top-level addresses to
   // Memory addresses
   ////////////////////////////////////////////////////////////////////////////
   generate
      if (DIAG_SIM_MEMORY_PRELOAD_AFT_SYNTH_OVRD) begin : gen_preload
         altera_emif_arch_nd_emif2mem # (
            .PROTOCOL_ENUM                         (PROTOCOL_ENUM),
            .PHY_CONFIG_ENUM                       (PHY_CONFIG_ENUM),
            .DIAG_USE_ABSTRACT_PHY                 (DIAG_USE_ABSTRACT_PHY_AFT_SYNTH_OVRD),
            .DIAG_SIM_MEMORY_PRELOAD_EMIF_FILE     (DIAG_SIM_MEMORY_PRELOAD_PRI_EMIF_FILE),
            ...
            .HMC_CFG_CS_ADDR_WIDTH                 (PRI_HMC_CFG_CS_ADDR_WIDTH),
            .HMC_CFG_ROW_ADDR_WIDTH                (PRI_HMC_CFG_ROW_ADDR_WIDTH),
            .HMC_CFG_CTRL_ENABLE_ECC               (PRI_HMC_CFG_CTRL_ENABLE_ECC),
            .CTRL_AMM_ADDRESS_WIDTH                (CTRL_AMM_ADDRESS_WIDTH),
            .CTRL_AMM_DATA_WIDTH                   (CTRL_AMM_DATA_WIDTH),
            .CTRL_AMM_BYTEEN_WIDTH                 (CTRL_AMM_BYTEEN_WIDTH),
            .MEM_BURST_LENGTH                      (MEM_BURST_LENGTH),
            .MEM_DATA_MASK_EN                      (MEM_DATA_MASK_EN),
            .MEM_CS_N_WIDTH                        (PHY_PING_PONG_EN ? PORT_MEM_CS_N_WIDTH/2: PORT_MEM_CS_N_WIDTH),
            .MEM_ROW_ADDR_WIDTH                    (MEM_ROW_ADDR_WIDTH),
            .MEM_COL_ADDR_WIDTH                    (MEM_COL_ADDR_WIDTH),
            .MEM_DQ_WIDTH                          (PHY_PING_PONG_EN ? PORT_MEM_DQ_WIDTH/2 : PORT_MEM_DQ_WIDTH),
            .PORT_MEM_C_WIDTH                      (PORT_MEM_C_WIDTH),
            .PORT_MEM_BG_WIDTH                     (PORT_MEM_BG_WIDTH),
            .PORT_MEM_BA_WIDTH                     (PORT_MEM_BA_WIDTH)
         ) emif2mem_inst (
         ...
         if (PHY_PING_PONG_EN) begin : pp
            altera_emif_arch_nd_emif2mem # (
               ...
               .PHY_CONFIG_ENUM                       (PHY_CONFIG_ENUM),
               .DIAG_USE_ABSTRACT_PHY                 (DIAG_USE_ABSTRACT_PHY_AFT_SYNTH_OVRD),
               .DIAG_SIM_MEMORY_PRELOAD_EMIF_FILE     (DIAG_SIM_MEMORY_PRELOAD_SEC_EMIF_FILE),
               ...
               .HMC_CFG_ADDR_ORDER                    (SEC_HMC_CFG_ADDR_ORDER),
               .HMC_CFG_CS_ADDR_WIDTH                 (SEC_HMC_CFG_CS_ADDR_WIDTH),
               .HMC_CFG_ROW_ADDR_WIDTH                (SEC_HMC_CFG_ROW_ADDR_WIDTH),
               .HMC_CFG_CTRL_ENABLE_ECC               (SEC_HMC_CFG_CTRL_ENABLE_ECC),
               .CTRL_AMM_ADDRESS_WIDTH                (CTRL_AMM_ADDRESS_WIDTH),
               .CTRL_AMM_DATA_WIDTH                   (CTRL_AMM_DATA_WIDTH),
               .CTRL_AMM_BYTEEN_WIDTH                 (CTRL_AMM_BYTEEN_WIDTH),
               .MEM_BURST_LENGTH                      (MEM_BURST_LENGTH),
