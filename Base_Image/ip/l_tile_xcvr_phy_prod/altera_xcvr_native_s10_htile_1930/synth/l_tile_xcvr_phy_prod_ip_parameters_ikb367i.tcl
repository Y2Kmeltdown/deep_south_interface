...
set ::GLOBAL_corename l_tile_xcvr_phy_prod_altera_xcvr_native_s10_htile_1930_ikb367i
# -------------------------------- #
# --- Default Profile settings --- #
# -------------------------------- #
dict set native_phy_ip_params channels_profile0 "4"
dict set native_phy_ip_params set_data_rate_profile0 "12500"
...
dict set native_phy_ip_params enh_pcs_pma_width_profile0 "32"
...
dict set native_phy_ip_params tx_clkout_sel_profile0 "pma_div_clkout"
dict set native_phy_ip_params rx_clkout_sel_profile0 "pma_div_clkout"
...
dict set native_phy_ip_params tx_clkout2_sel_profile0 "pcs_clkout"
