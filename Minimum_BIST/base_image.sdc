...
set_multicycle_path -from [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if_0|fce_data_pll[*]}]    -to [get_ports {conf_d[*]}]     -setup -end 2
set_multicycle_path -from [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if_0|fce_data_oe_pll[*]}] -to [get_ports {conf_d[*]}]     -setup -end 2
set_multicycle_path -from [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if_0|*_pll}]              -to [get_ports {conf_c_out[*]}] -setup -end 2
...
set_false_path -to [get_registers {u2|init_done_meta[0]}]
set_false_path -to [get_registers {u5|shift_reg[0]}]
set_false_path -to [get_registers {u6|shift_reg[0]}]
...
set_false_path -from [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if|fce_data_pll[*]}]    -to [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if|retime_confd_0|q_i[0][*]}]
set_false_path -from [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if|fce_data_oe_pll[*]}] -to [get_registers {u0|qsys_sys_mgr|system_manager_if|system_manager_if|retime_confd_0|q_i[0][*]}]
...
set_false_path -from [get_registers {u0|av_hbm*|tg_*}] -to [get_registers {u0|av_hbm*|readdata_d1[*]}]

set_false_path -from [get_registers {u0|av_hbm*|*wmcrst**reset_*}] -to  [get_registers {u0|av_hbm*|reset_reg*[*]}]
