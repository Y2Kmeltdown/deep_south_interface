// qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_maalyoy.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_maalyoy #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 122,
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 122,          .data
		...
		.out_data          (out_data),          //  output,  width = 122,          .data
