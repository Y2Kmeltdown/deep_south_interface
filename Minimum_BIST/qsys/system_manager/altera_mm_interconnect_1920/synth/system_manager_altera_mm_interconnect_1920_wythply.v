// system_manager_altera_mm_interconnect_1920_wythply.v
...
`timescale 1 ps / 1 ps
module system_manager_altera_mm_interconnect_1920_wythply (
		input  wire [9:0]  system_manager_if_mem_if_address,                                      //                                        system_manager_if_mem_if.address
		...
		input  wire        system_manager_if_mem_if_translator_reset_reset_bridge_in_reset_reset, // system_manager_if_mem_if_translator_reset_reset_bridge_in_reset.reset
	...
	system_manager_altera_merlin_master_translator_191_g7h47bq #(
		...
		.reset                  (system_manager_if_mem_if_translator_reset_reset_bridge_in_reset_reset),       //   input,   width = 1,                     reset.reset
		...
		.av_address             (system_manager_if_mem_if_address),                                            //   input,  width = 10,      avalon_anti_master_0.address
