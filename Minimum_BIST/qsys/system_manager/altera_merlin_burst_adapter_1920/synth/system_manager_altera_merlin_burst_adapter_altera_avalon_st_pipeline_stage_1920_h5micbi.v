// system_manager_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_h5micbi.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module system_manager_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_h5micbi #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 72,
	...
	system_manager_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 72,          .data
		...
		.out_data          (out_data),          //  output,  width = 72,          .data
