	component system_manager_system_manager_if_0 is
		port (
			...
			d_address              : out   std_logic_vector(9 downto 0);                     -- address
	...
	end component system_manager_system_manager_if_0;

	u0 : component system_manager_system_manager_if_0
		port map (
			clk                    => CONNECTED_TO_clk,                    --                    clk.clk
			rst                    => CONNECTED_TO_rst,                    --            Reset_Input.reset
