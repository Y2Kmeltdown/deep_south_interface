	system_manager_system_manager_if_0 u0 (
		.clk                    (_connected_to_clk_),                    //   input,   width = 1,                    clk.clk
		.rst                    (_connected_to_rst_),                    //   input,   width = 1,            Reset_Input.reset
		...
		.d_address              (_connected_to_d_address_),              //  output,  width = 10,                 mem_if.address
