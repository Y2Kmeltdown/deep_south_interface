...
module qsys_top_avmm_bridge_512_0_altera_xcvr_fpll_s10_htile_1912_mcprpcy
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_mcprpcy 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_mcprpcy phase_en_pulse(
        ...
        dps_reset_gen_mcprpcy dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
