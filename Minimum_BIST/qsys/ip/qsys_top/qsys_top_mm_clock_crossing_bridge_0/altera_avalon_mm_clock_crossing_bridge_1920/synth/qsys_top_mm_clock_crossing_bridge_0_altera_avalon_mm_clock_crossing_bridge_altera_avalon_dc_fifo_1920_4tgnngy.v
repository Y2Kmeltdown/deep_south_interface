// qsys_top_mm_clock_crossing_bridge_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_4tgnngy.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module qsys_top_mm_clock_crossing_bridge_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_4tgnngy #(
		parameter SYMBOLS_PER_BEAT          = 1,
		parameter BITS_PER_SYMBOL           = 52,
		...
		input  wire [51:0] in_data,     //            in.data
		input  wire        in_valid,    //              .valid
		output wire        in_ready,    //              .ready
		output wire [51:0] out_data,    //           out.data
	...
	qsys_top_mm_clock_crossing_bridge_0_altera_avalon_dc_fifo_1940_j7a573y #(
		...
		.in_data            (in_data),                              //   input,  width = 52,            in.data
		.in_valid           (in_valid),                             //   input,   width = 1,              .valid
		.in_ready           (in_ready),                             //  output,   width = 1,              .ready
		.out_data           (out_data),                             //  output,  width = 52,           out.data
