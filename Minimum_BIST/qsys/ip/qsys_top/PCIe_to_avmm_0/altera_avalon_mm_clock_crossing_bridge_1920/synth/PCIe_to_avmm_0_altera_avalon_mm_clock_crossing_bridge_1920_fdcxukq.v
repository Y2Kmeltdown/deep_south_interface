...
`timescale 1 ns / 1 ns
module PCIe_to_avmm_0_altera_avalon_mm_clock_crossing_bridge_1920_fdcxukq 
#(
...
(
    ...
    PCIe_to_avmm_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_mllx4ha #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    PCIe_to_avmm_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_2yfh36y #(
        .SYMBOLS_PER_BEAT   (1),
