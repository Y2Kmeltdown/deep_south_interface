...
`timescale 1 ns / 1 ns
module dr_mm_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_1920_fdcxukq 
#(
...
(
    ...
    dr_mm_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_2h5kwci #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    dr_mm_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_oi5d4sq #(
        .SYMBOLS_PER_BEAT   (1),
