// hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_nbvxvca.v

// Generated using ACDS version 20.4 72

`timescale 1 ps / 1 ps
module hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_nbvxvca #(
		parameter SYMBOLS_PER_BEAT          = 1,
		parameter BITS_PER_SYMBOL           = 327,
		...
		input  wire [326:0] in_data,     //            in.data
		input  wire         in_valid,    //              .valid
		output wire         in_ready,    //              .ready
		output wire [326:0] out_data,    //           out.data
	...
	hbm_0_0_clock_crossing_bridge_altera_avalon_dc_fifo_1940_j7a573y #(
		...
		.in_data            (in_data),                              //   input,  width = 327,            in.data
		.in_valid           (in_valid),                             //   input,    width = 1,              .valid
		.in_ready           (in_ready),                             //  output,    width = 1,              .ready
		.out_data           (out_data),                             //  output,  width = 327,           out.data
