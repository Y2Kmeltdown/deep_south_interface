// hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_vlemumq.v

// Generated using ACDS version 20.4 72

`timescale 1 ps / 1 ps
module hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_vlemumq #(
		parameter SYMBOLS_PER_BEAT          = 1,
		parameter BITS_PER_SYMBOL           = 256,
		...
		output wire [4:0]   space_avail_data  //   space_avail.data
	);
	...
	hbm_0_0_clock_crossing_bridge_altera_avalon_dc_fifo_1940_j7a573y #(
		...
		.space_avail_data   (space_avail_data),                     //  output,    width = 5,   space_avail.data
