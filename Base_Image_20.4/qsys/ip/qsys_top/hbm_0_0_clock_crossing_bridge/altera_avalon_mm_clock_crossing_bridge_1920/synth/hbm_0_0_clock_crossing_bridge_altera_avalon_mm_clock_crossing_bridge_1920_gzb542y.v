...
`timescale 1 ns / 1 ns
module hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_1920_gzb542y 
#(
...
(
    ...
    hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_nbvxvca #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    hbm_0_0_clock_crossing_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_vlemumq #(
        .SYMBOLS_PER_BEAT   (1),
