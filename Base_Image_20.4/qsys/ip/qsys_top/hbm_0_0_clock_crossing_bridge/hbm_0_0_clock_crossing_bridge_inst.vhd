	component hbm_0_0_clock_crossing_bridge is
		generic (
			DATA_WIDTH          : integer := 256;
			SYMBOL_WIDTH        : integer := 8;
			HDL_ADDR_WIDTH      : integer := 34;
			BURSTCOUNT_WIDTH    : integer := 2;
			COMMAND_FIFO_DEPTH  : integer := 16;
			RESPONSE_FIFO_DEPTH : integer := 16;
	...
	end component hbm_0_0_clock_crossing_bridge;

	u0 : component hbm_0_0_clock_crossing_bridge
		generic map (
