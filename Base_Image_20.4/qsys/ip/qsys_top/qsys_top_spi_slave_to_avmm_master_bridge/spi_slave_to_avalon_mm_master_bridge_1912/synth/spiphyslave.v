...
parameter  DEVICE_FAMILY = "Stratix 10"; /*Device family chosen, if DM device, need to use IO PAD for tri-state buffer*/
...
defparam SPIPhy_MISOctl.DEVICE_FAMILY = DEVICE_FAMILY;
...
generate
    if (DEVICE_FAMILY == "Diamond Mesa") begin 
      eip_dm_io_pad #(                                                                                                                                                                                                                                                          
        .IOTYPE    ("bs"),
        .IOVOLTAGE ("1v8"),
        .RXSTRUCT  ("off"),
