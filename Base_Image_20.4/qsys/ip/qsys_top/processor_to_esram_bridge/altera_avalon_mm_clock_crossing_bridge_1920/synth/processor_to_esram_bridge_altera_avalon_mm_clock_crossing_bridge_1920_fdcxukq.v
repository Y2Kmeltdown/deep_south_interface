...
`timescale 1 ns / 1 ns
module processor_to_esram_bridge_altera_avalon_mm_clock_crossing_bridge_1920_fdcxukq 
#(
...
(
    ...
    processor_to_esram_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_jbkcjpa #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    processor_to_esram_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_2yfh36y #(
        .SYMBOLS_PER_BEAT   (1),
