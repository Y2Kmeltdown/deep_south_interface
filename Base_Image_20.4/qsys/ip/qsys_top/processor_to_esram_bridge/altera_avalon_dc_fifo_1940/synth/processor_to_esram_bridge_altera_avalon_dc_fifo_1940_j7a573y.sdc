...
#-------------------------------------------------------------------------------
set all_dc_fifo [get_entity_instances processor_to_esram_bridge_altera_avalon_dc_fifo_1940_j7a573y]
...
set mem_regs [get_registers -nowarn *|processor_to_esram_bridge_altera_avalon_dc_fifo_1940_j7a573y:*|mem*];
if {![llength [query_collection -report -all $mem_regs]] > 0} {
    set mem_regs [get_registers -nowarn processor_to_esram_bridge_altera_avalon_dc_fifo_1940_j7a573y:*|mem*];
}

set internal_out_payload_regs [get_registers -nowarn *|processor_to_esram_bridge_altera_avalon_dc_fifo_1940_j7a573y:*|internal_out_payload*];
