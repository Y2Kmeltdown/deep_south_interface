...
module qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_top #(
   ...
   parameter SEQ_SYNTH_CODE_HEX_FILENAME             = "qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_top_uibssm_synth.hex",
   parameter SEQ_SYNTH_CODE_FW_FILENAME              = "",
   parameter SEQ_SYNTH_PARAMS_HEX_FILENAME           = "qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_top_seq_params_synth.hex",
   parameter SEQ_SYNTH_CAL_CLK_DIVIDE                = 0,

   parameter SEQ_SIM_CODE_HEX_FILENAME               = "qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_top_uibssm_sim.hex",
   parameter SEQ_SIM_CODE_FW_FILENAME                = "",
   parameter SEQ_SIM_PARAMS_HEX_FILENAME             = "qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_top_seq_params_sim.hex",
...
`endif
   ...
   generate
      ...
      // synthesis translate_on
         altera_hbm_arch_nd_pll_qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva pll_inst (
            .*
         );
      // synthesis translate_off
      end
   ...
   .HBMC_CH7_CORE_CLOCK_PS(HBMC_CH7_CORE_CLOCK_PS)
      ...
      if (LOCAL_DIAG_ABSTRACT_PHY) begin
         ...
         if (!PLL_CPA_ONLY_MODE) begin
            ...
            qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_uibssm #(
