...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_initialize_hbm_db hbm_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_corename}"
   } else {
      set fbasename "${::GLOBAL_qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_corename}_${inst_id}"
   }
   ...
   qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance   

   set summary [lsort -command qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_sort_proc $summary]

   set f -1
   set fname "${fbasename}_summary.csv"

   if { [qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_get_operating_conditions_number] == 0 } {
      set f [open $fname w]

      puts $f "Core: ${::GLOBAL_qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_corename} - Instance: $inst"
   ...
   post_message -type info "Core: ${::GLOBAL_qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ qsys_top_hbm_0_altera_abstract_uib_191_bkp7vva_round_3dp $hold]
      }
