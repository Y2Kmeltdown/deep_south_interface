...
`timescale 1 ns / 1 ns
module qsys_top_mm_clock_crossing_bridge_0_altera_avalon_mm_clock_crossing_bridge_1920_fdcxukq 
#(
...
(
    ...
    qsys_top_mm_clock_crossing_bridge_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_4tgnngy #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    qsys_top_mm_clock_crossing_bridge_0_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_oi5d4sq #(
        .SYMBOLS_PER_BEAT   (1),
