...
################################################################
proc hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis {opcname inst var_array_name summary_name title from_clks to_clks from_nodes to_nodes } {
...
proc hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis_min_pulse {opcname inst var_array_name summary_name title to_nodes } {
...
proc hbm_top_example_design_altera_abstract_uib_191_e5nceni_perform_core_analysis {opcname inst pin_array_name var_array_name summary_name} {
   ...
   # Core-to-periphery
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "Core To Periphery" $allclocks $allclocks "*" $periphery_regs]
   ...
   # Periphery-to-core
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "Periphery To Core" $allclocks $allclocks $periphery_regs "*"]
   set setup_margin    [min $setup_margin    [lindex $res 0]]
   set hold_margin     [min $hold_margin     [lindex $res 1]]
   set recovery_margin [min $recovery_margin [lindex $res 2]]
   set removal_margin  [min $removal_margin  [lindex $res 3]]
   ...
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "Within Core" $allclocks $allclocks $hbm_core_regs $hbm_core_regs]
   set setup_margin    [min $setup_margin    [lindex $res 0]]
   set hold_margin     [min $hold_margin     [lindex $res 1]]
   set recovery_margin [min $recovery_margin [lindex $res 2]]
   set removal_margin  [min $removal_margin  [lindex $res 3]]
   ...
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "IP to User Logic" $allclocks $allclocks $hbm_core_regs $rest_regs]
   set setup_margin    [min $setup_margin    [lindex $res 0]]
   set hold_margin     [min $hold_margin     [lindex $res 1]]
   set recovery_margin [min $recovery_margin [lindex $res 2]]
   set removal_margin  [min $removal_margin  [lindex $res 3]]
   ...
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "User Logic to IP" $allclocks $allclocks $rest_regs $hbm_core_regs]
   set setup_margin    [min $setup_margin    [lindex $res 0]]
   set hold_margin     [min $hold_margin     [lindex $res 1]]
   set recovery_margin [min $recovery_margin [lindex $res 2]]
   set removal_margin  [min $removal_margin  [lindex $res 3]]
   ...
   if {$var(DIAG_TIMING_REGTEST_MODE)} {
      set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis $opcname $inst var global_summary "Within User Logic" $allclocks $allclocks $rest_regs $rest_regs]
      set setup_margin    [min $setup_margin    [lindex $res 0]]
      set hold_margin     [min $hold_margin     [lindex $res 1]]
      set recovery_margin [min $recovery_margin [lindex $res 2]]
      set removal_margin  [min $removal_margin  [lindex $res 3]]
   ...
   set res [hbm_top_example_design_altera_abstract_uib_191_e5nceni_add_report_timing_analysis_min_pulse $opcname $inst var global_summary "Periphery" $periphery_regs]
