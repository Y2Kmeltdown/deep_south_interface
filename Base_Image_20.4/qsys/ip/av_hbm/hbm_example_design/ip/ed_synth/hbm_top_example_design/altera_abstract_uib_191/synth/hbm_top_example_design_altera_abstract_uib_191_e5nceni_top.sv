...
module hbm_top_example_design_altera_abstract_uib_191_e5nceni_top #(
   ...
   parameter SEQ_SYNTH_CODE_HEX_FILENAME             = "hbm_top_example_design_altera_abstract_uib_191_e5nceni_top_uibssm_synth.hex",
   parameter SEQ_SYNTH_CODE_FW_FILENAME              = "",
   parameter SEQ_SYNTH_PARAMS_HEX_FILENAME           = "hbm_top_example_design_altera_abstract_uib_191_e5nceni_top_seq_params_synth.hex",
   parameter SEQ_SYNTH_CAL_CLK_DIVIDE                = 0,

   parameter SEQ_SIM_CODE_HEX_FILENAME               = "hbm_top_example_design_altera_abstract_uib_191_e5nceni_top_uibssm_sim.hex",
   parameter SEQ_SIM_CODE_FW_FILENAME                = "",
   parameter SEQ_SIM_PARAMS_HEX_FILENAME             = "hbm_top_example_design_altera_abstract_uib_191_e5nceni_top_seq_params_sim.hex",
...
`endif
   ...
   begin
	 ...
	 real_axifencereq_4 <= 4'hf;
         ...
         sync_cal_in_prog_1 <= PROT_MODE == "ASIC"? {4{real_cal_in_prog | real_axifencereq | apply_hbm_rst}} : {4{real_cal_in_prog}};
   ...
   generate
      ...
      // synthesis translate_on
         altera_hbm_arch_nd_pll_hbm_top_example_design_altera_abstract_uib_191_e5nceni pll_inst (
            .*
         );
      // synthesis translate_off
      end
   ...
   .HBMC_CH7_CORE_CLOCK_PS(HBMC_CH7_CORE_CLOCK_PS)
      ...
      if (LOCAL_DIAG_ABSTRACT_PHY) begin
         ...
         if (!PLL_CPA_ONLY_MODE) begin
            ...
            hbm_top_example_design_altera_abstract_uib_191_e5nceni_uibssm #(
